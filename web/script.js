document.addEventListener('DOMContentLoaded', function () {
    ...
    const learningPaths = {
        ...
        "CSS": [
            { task: "Introduction to CSS", time: "30 mins" },
            { task: "Basic Styling", time: "40 mins" },
            { task: "The Box Model", time: "50 mins" },
            { task: "Layouts and Positioning", time: "60 mins" },
            { task: "Flexbox and Grid", time: "90 mins" },
            { task: "Responsive Design", time: "70 mins" },
            { task: "CSS3 Features", time: "50 mins" },
            { task: "CSS Variables and Best Practices", time: "40 mins" }
        ],
        "SQL": [
            { task: "Introduction to SQL", time: "30 mins" },
            { task: "Basic Queries", time: "40 mins" },
            { task: "Data Manipulation", time: "45 mins" },
            { task: "Functions and Aggregates", time: "50 mins" },
            { task: "Joins", time: "60 mins" },
            { task: "Subqueries", time: "50 mins" },
            { task: "Indexes and Optimization", time: "40 mins" },
            { task: "Database Design (optional)", time: "90 mins" }
        ]
    };
